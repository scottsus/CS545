...
set_target_properties(libada PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libada.so.0.2.0"
  IMPORTED_SONAME_NOCONFIG "libada.so.0.2.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS libada )
list(APPEND _IMPORT_CHECK_FILES_FOR_libada "${_IMPORT_PREFIX}/lib/libada.so.0.2.0" )
